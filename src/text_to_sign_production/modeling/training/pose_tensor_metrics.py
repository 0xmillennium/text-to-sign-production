"""Confidence-masked tensor metrics for full-BFH pose predictions."""
...
def masked_average_keypoint_l2_error(
    ...
    from ._surface import floating_point_accumulation_dtype, iter_validated_pose_channels
...
def _temporal_diagnostics(
    ...
    from ._surface import floating_point_accumulation_dtype
