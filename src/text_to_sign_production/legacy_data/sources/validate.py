...
from text_to_sign_production.legacy_data._shared.validate import is_non_empty_text, path_has_name
from text_to_sign_production.legacy_data.sources.types import SourceCandidate, SourceValidationIssue
