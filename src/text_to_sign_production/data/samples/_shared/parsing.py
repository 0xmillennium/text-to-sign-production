...
from text_to_sign_production.data._shared.validate import format_keys, missing_keys
...
def selected_person_from_record(record: Mapping[str, Any]) -> SelectedPersonMetadata:
    ...
    from text_to_sign_production.data.samples.schema import REQUIRED_SELECTED_PERSON_KEYS
...
def frame_quality_from_record(record: Mapping[str, Any]) -> FrameQualitySummary:
    ...
    from text_to_sign_production.data.samples.schema import REQUIRED_FRAME_QUALITY_KEYS
