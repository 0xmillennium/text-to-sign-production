...
from text_to_sign_production.data._shared.analysis import safe_ratio
...
def build_leakage_affected_sample_coverage_records(
    ...
    splits = sorted({summary.split for summary in bundle.sample_summaries}, key=lambda item: item.value)
