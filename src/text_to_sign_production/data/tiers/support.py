"""Upper-body landmark-density support tier threshold parsing and evaluation."""
...
def parse_upper_body_support_thresholds(
    ...
    """Parse strict upper-body landmark-density support thresholds for every filter level."""
    ...
    for level in FilterLevel:
        ...
        parsed[level] = UpperBodySupportThresholds(
            min_active_span_upper_body_support_landmark_coverage_ratio=require_ratio(
                level_payload["min_active_span_upper_body_support_landmark_coverage_ratio"],
...
def evaluate_upper_body_support_family(
    ...
    """Evaluate upper-body landmark-density support metrics against the applied level."""
    return tuple(
        failure
