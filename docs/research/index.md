...
`docs/research` captures the thesis-path planning, literature framing, and contribution-selection rationale that sit after Dataset Build.

These pages are research-planning and research-positioning surfaces, not execution guides, experiment records, or artifact inventories. For current workflow behavior, use [Execution](../execution.md). For empirical evidence, use [Experiments](../experiments/index.md).

The current research surface now includes a completed contribution-audit outcome. That outcome fixes the current thesis-facing contribution pair as:
