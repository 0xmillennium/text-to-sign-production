...
This directory is the permanent audit surface for the completed current contribution audit. It records the audit framework, the family-level and candidate-level evidence surfaces, and the final audit outcome once candidate evaluation and decision-making have been completed.

Family-level universe records and candidate-level evidence records are already instantiated.
[Scorecards](scorecards/index.md), [Selection Decisions](selection-decisions/index.md), and
[Audit Result](audit-result.md) remain downstream audit surfaces.

## Navigation

Use this area in the following order:

1. Start here for audit scope and document roles.
...
- [Audit Result](audit-result.md): authoritative final audit-outcome surface for the whole audit
...
- The contribution-audit structure is instantiated.
- Family-level universe records are populated.
- Candidate-level evidence records are populated.
- Scorecards and selection-decision records remain downstream audit surfaces.
- No final audit outcome is recorded in this index document.
