...
- Drive-published archive path: `<PROJECT_ARTIFACT_ROOT>/baseline-modeling/runs/<run_name>/archives/baseline_training_outputs.tar.zst`

## Verified Example Path

- `<PROJECT_ARTIFACT_ROOT>/baseline-modeling/runs/190420261845/archives/baseline_training_outputs.tar.zst`
